...
/**
  * The money-transfer service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the MoneytransferService.
  */
trait MoneytransferService extends Service {
  ...
  override final def descriptor: Descriptor = {
    import Service._
    // @formatter:off
    named("money-transfer")
      .withCalls(
        pathCall("/api/hello/:id", hello _),
        pathCall("/api/hello/:id", useGreeting _)
      )
      .withTopics(
        topic(MoneytransferService.TOPIC_NAME, greetingsTopic _)
